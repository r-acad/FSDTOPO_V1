...
ngauss = min(40, Int(ceil((min((iter / Niter),.95))* nelx * conv_scale/100) )) # 40 is a safe limit for a static array in a Ryzen9, reduce or remove mutable static array when publishing
